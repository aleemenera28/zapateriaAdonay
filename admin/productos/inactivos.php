...
<main>
    <div class="container-fluid px-4"><br>
        ...
        <a href="nuevo.php" class="btn btn-primary">Nuevo</a><br><br>
                ...
                <tbody>
                    <?php foreach($productos as $producto){ ?>
                        <tr>
                            ...
                            <td>
                            <a href="edita.php?id=<?php echo $producto['idProductos']?>" class="btn btn-warning btn-sm">Editar</a>
                            </td>
                            <td><button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalElimina" data-bs-id="<?php echo $producto['idProductos']; ?>">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
