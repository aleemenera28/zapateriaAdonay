...
$sql = $con->prepare("SELECT idProductos, nombre, precio FROM tablaproductos WHERE activo=1 AND marca='Skechers';");
$sql->execute();
...
<?php include '../navegacion.php'; ?>
    ...
    <footer class="text-center text-primary fixed-bottom mt-5">
        <div class="text-center p-3" id="barraNav">
            © 2023 Copyright:
            <a class="text-primary" href="#">Derechos reservados para Alejandro, Rogelio, Reyna y Gael, pinche azteca negro</a>
        </div>
    </footer>
    <div id="burbujas">
        <div id="burbuja"></div>
